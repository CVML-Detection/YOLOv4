...
class COCO_Test_Dev_Dataset(Dataset):
    def __init__(self, root='D:\Data\coco', set_name='test2017', split='test', download=True, resize=300):
        super().__init__()
...
if __name__ == '__main__':
    coco_dataset = COCO_Test_Dev_Dataset(root="D:/data/coco", set_name='test2017', split='test', download=True, resize=300)
